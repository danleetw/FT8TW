 ...
 * @author BGY70Z
 * @date 2023-03-20
 * @date 2025/7/12 把volumeObserver記錄起來，結束時 dimiss他
 */
...
public class SetVolumeDialog extends Dialog {
	...
	// 把 Observer 提取成 field (volumeObserver)
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		*/
		GeneralVariables.mutableVolumePercent.observeForever(volumeObserver); // 改用 Class中物件(BV6LC)
