...
public class KenwoodTK90RigConstant {
	...
	private static final String DMX_SET_USB = "MD6;";// DMX USB MODE
	...
	private static final String TS590_READ_METERS = "RM1;";//KENWOOD 读METER
	...
	public static byte[] setDmxOperationUSBMode() {
        return DMX_SET_USB.getBytes();
    }
