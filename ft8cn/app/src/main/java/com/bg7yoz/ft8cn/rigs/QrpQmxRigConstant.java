...
public class QrpQmxRigConstant {
    private static final String TAG = "QMXRigConstant";
	...
	public static final int ts_590_swr_alert_max = 1500;//相当于3.0
    public static final int ts_590_alc_alert_max = 15;//超过，在表上显示红色

    //PTT状态

    //指令集
    private static final String PTT_ON = "TX1;";    //KENWOOD TS590,PTT
    ...
    private static final String PTT_OFF = "RX;";        //KENWOOD TS590,PTT
    //private static final String USB_MODE = "MD6;Q410;";      // QMX Digi Node Set TX Rise Threshold to 10，避免QMX不發射
	//private static final String USB_MODE = "MD6;Q45;";      // QMX Digi Node Set TX Rise Threshold to 5，避免QMX不發射
	private static final String USB_MODE = "MD6;Q41;";      // QMX Digi Node Set TX Rise Threshold to 1，避免QMX不發射
    private static final String READ_FREQ = "FA;";     //KENWOOD 读频率
    private static final String READ_METERS = "SW;"; //KENWOOD 读METER
	private static final String READ_POWER = "PC;"; //KENWOOD 读METER
    private static final String SET_VFO = "FR0;";
	...
	*/
    ...
    public static byte[] setOperationUSBMode() {
		//ToastMessage.show(String.format(" set USB=%s",USB_MODE));
    ...
    public static byte[] setReadMeters() {
	    ...
	    public static byte[] setReadPower() {
        return READ_POWER.getBytes();
    }
