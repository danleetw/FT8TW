...
public class Yaesu3RigConstant {
	...
	private static final String READ_39METER_POWER = "PC;";//38,39的指令都是一样的
	...
	// FX-TX1 指令
	private static final String VFO_A = "VS0;";     // 切換到 VFO-A
	private static final String VFO_B = "VS1;";     // 切換到 VFO-B
	private static final String SPLIT_OFF = "FT0;"; // Split OFF
	private static final String SPLIT_ON  = "FT1;"; // Split ON
	// ===== STATUS QUERY =====
	private static final String READ_IF = "IF;";
	...
	public static byte[] setRead39Meters_POWER(){
        return READ_39METER_POWER.getBytes();
    }
	
	// FX-TX指令
	public static byte[] setVFO_A() {
		return VFO_A.getBytes();
	}
	public static byte[] setVFO_B() {
		return VFO_B.getBytes();
	}

	public static byte[] setSplitOff() {
		return SPLIT_OFF.getBytes();
	}

	public static byte[] setSplitOn() {
		return SPLIT_ON.getBytes();
	}
	
	public static byte[] setReadIF() {
		return READ_IF.getBytes();
	}
