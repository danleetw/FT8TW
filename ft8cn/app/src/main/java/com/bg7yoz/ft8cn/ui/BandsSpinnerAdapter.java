...
public class BandsSpinnerAdapter extends BaseAdapter {
    ...
    public BandsSpinnerAdapter(Context context) {
        ...
        mContext=context;
		int pos = OperationBand.ensureCurrentBandExists(GeneralVariables.band , GeneralVariables.isFT4);
		GeneralVariables.bandListIndex = pos;
		GeneralVariables.band = OperationBand.getBandFreq(pos);
    }

    @Override
    public int getCount() {
		if(OperationBand.bandList!=null)
