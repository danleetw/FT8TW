...
public class HtmlContext {
    private static final String HTML_HEAD = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\"> <html><head><title>" + GeneralVariables.getStringFromResource(R.string.app_name) + " " +
			" Admin Console Ver:" + BuildConfig.VERSION_NAME +"</title>\n" +
    ...
    public static String DEFAULT_HTML() {
        return HTML_STRING("<table bgcolor=#a1a1a1 border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" +
				...
				"<tr><td class=\"default\" colspan=\"15\"><a href=/DEBUG_MONITOR>" +
				GeneralVariables.getStringFromResource(R.string.SSE_urlTitle) +
                 "</a></td></tr>" +
