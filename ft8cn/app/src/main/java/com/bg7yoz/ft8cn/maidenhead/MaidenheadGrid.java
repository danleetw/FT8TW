...
public class MaidenheadGrid {
    ...
    public static String getDistStr(String mGrid1, String mGrid2) {
        double km = getDist(mGrid1, mGrid2);
        if (km == 0) {
            return "";
        } else {
            //return String.format(GeneralVariables.getStringFromResource(R.string.distance), dist)+"A";
			if (isUsingMiles()) {
	...
	public static boolean isUsingMiles() {
		...
		return  (country.equalsIgnoreCase("US")
				|| country.equalsIgnoreCase("LR")  // 利比里亞
				|| country.equalsIgnoreCase("MM")); // 緬甸
	}
