...
public class Js8DecodedMessage {
    static {
        //System.loadLibrary("js8tw"); // 
		try {
        System.loadLibrary("js8tw");
			LogExt.d("JS8JNI", "System.loadLibrary(js8tw) OK");
		} catch (Throwable t) {
			LogExt.d("JS8JNI", "System.loadLibrary(js8tw) FAILED");
		}
	...
	public Js8DecodedMessage() {
	}
	
	public Js8DecodedMessage(String text, int snr, float freq) {
		this.report = text;
		this.snr = snr;
		this.freq_hz = freq;
	}
	...
	public  Js8DecodedMessage(String callFrom,String callsignTo, String maidenGrid, String report, float freq_hz,int snr,float time_sec,boolean isMyCall) {
	...
	public static native Js8DecodedMessage decodeFromVoice(java.nio.ByteBuffer voiceBuf);
	...
	public static native float[] generateJs8(Ft8Message msg, float frequency, int sample_rate,boolean is_ft4);
