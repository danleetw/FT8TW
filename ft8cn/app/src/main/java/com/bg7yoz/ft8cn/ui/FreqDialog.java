...
public class FreqDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        freqRecyclerView.scrollToPosition(OperationBand.getIndexByFreq(GeneralVariables.band , GeneralVariables.isFT4));
//
...
//        };
    ...
    public void show() {
        ...
        if (width>height) { //直式
            params.width = (int) (width * (0.5+0.2));
            params.height = (int) (height * 0.6);
        }else {
            params.width= (int) (width * (0.6+0.2));
   ...
   public class FreqAdapter  extends RecyclerView.Adapter<FreqAdapter.FreqHolder>{
       ...
       public void onBindViewHolder(@NonNull FreqHolder holder, int position) {
           ...
           holder.operationDialogBandConstraintLayout.setOnClickListener(new View.OnClickListener() {
               @Override
               public void onClick(View view) {
                   GeneralVariables.bandListIndex = OperationBand.getIndexByFreq(holder.band , GeneralVariables.isFT4);
